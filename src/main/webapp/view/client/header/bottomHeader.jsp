				...
				<div class="aa-header-bottom-area">
					...
					<div class="aa-logo">
						...
						<a href="${pageContext.request.contextPath}/"><img
							src="${url}/images/logo-balo.png" alt="logo img" width="200px" height="100px"></a>
					</div>
					<!-- / logo  -->
					<!-- Shipping service -->
					<div class="aa-shipping-box">
						...
						<a class="aa-shipping-boxsmall"> <span
							...
							class="aa-shipping-box-text">
								<div class="aa-shipping-title">Hỗ trợ: 0983-350-550</div>
					...
					<div class="aa-cartbox">
						<a class="aa-cart-link" href="${pageContext.request.contextPath}/view/client/cart"> <span

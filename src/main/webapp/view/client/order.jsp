...
<c:url value = "/view/client/assets" var="url"/>
  ...
  <section id="aa-catg-head-banner">
   <img src="${url}/images/banner/banner-cart.png" alt="banner đặt hàng">
  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
      	<div>
      		<h1 style ="text-align: center; color: #f17501;">Hướng dẫn đặt hàng</h1>
      		<strong>Các bước mua hàng trên Balo Hiệu: </strong>
      		<p>
			...
			<p>Cách thức thực hiện cực đơn giản, dễ dàng, và nhanh chóng và có đầy đủ hướng dẫn sẽ tiết kiệm thời gian mua hàng của khách hàng.</p>
      		...
      		<p>Ngoài mua hàng thông qua website, khách hàng cũng có thể đặt hàng các sản phẩm của <strong>Balo Hiệu</strong> qua Hotline: 19001234</p>

                ...
                <c:forEach items="${productlist}" var="product">
	                <li>
	                  <figure>
	                    ...
	                    <img src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}" alt="${product.name}"></a>
	                    <c:choose>
                ...
                <ul>
                 <c:forEach items="${productlist}" var="product" end="2">
                  <li>
                    ...
                    <img alt="img" src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${product.image_link}"></a>
